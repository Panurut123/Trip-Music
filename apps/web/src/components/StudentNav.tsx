...
export function StudentNav({ active }: { active: "home" | "queue" | "history" }) {
  return <>
    <header className="student-topbar"><Brand /><div className="top-actions"><Link href="/queue" aria-label="Profile">◉</Link><Link href="/admin" aria-label="Admin">⚙</Link></div></header>
